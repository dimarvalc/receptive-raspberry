---
title: "Pennsylvania Salt Manufacturing Company"
pubDate: 1938-10-17
serialNumber: "35797"
sharesCount: "25 Shares"
...
The reverse backing maps out a rapid legal transaction. On **October 20, 1938**, E. A. Pierce & Co. formally signed and endorsed the certificate, assigning the share blocks over to *(Mrs.) Henrietta A. S. Ingersoll*, living at the prestigious *1815 Walnut Street* address in Philadelphia.

To legally clear the stock volume transfer within the state, three matching fiscal stamps were affixed and hand-canceled:
* **State Revenue Tenders**: Three 2-cent blue *Commonwealth of Pennsylvania Stock Transfer Tax stamps*, each displaying the engraved portrait architecture of the state capitol building.
* **Perforation Security**: The right-hand backing features an elegant, circular pin-hole perforation matrix stamp validating the document's legal cancellation pipeline.